...
def compare_page(lang):
    ...
    extra = f'<script>window.GLOBAL_LANG = "{lang}";</script><script type="module" src="../../assets/js/player-compare.js?v=1"></script>'
    return document(lang, title, description, canonical, path, body, schema, extra)
...
def main():
    ...
    for lang in LANGS:
        ...
        urls.extend([f'{BASE}/{lang}/search/index.html', f'{BASE}/{lang}/players/index.html', f'{BASE}/{lang}/players/{PLAYER["slug"]}.html', f'{BASE}/{lang}/compare/players.html'])
