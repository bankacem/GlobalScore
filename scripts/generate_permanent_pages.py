...
def match_page(item, lang):
    ...
    script = f'<script>window.GLOBAL_MATCH = {script_data}; window.GLOBAL_LANG = "{lang}";</script><script type="module" src="../../assets/js/match-page.js?v=2"></script>'
